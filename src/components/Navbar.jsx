  ...
  return (
    <nav className="fixed top-6 inset-x-0 z-50 flex justify-center px-4">
      ...
      >
        ...
        {/* CTA Button */}
        {/* <a href="#contact"> */}
          <button onClick={onContactClick} className="bg-black text-white px-5 py-2 rounded-full text-sm font-medium hover:bg-gray-800 transition-all active:scale-95">
            Contact
          </button>
        {/* </a> */}
      </motion.div>
